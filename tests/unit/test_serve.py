...
mock_modules = [
    "fastrdp", "stravalib", "polyline", "numpy", "pandas", "plotly", 
    "plotly.colors", "plotly.graph_objects",
    "kaleido", "fitparse", "gpxpy", "maxplotlibx", "tikzfigure",
    "tabulate", "markdown"
]
...
class TestServe(unittest.TestCase):
    ...
    def test_serve_with_host(self, mock_print_instr, mock_activity, mock_collection, mock_sync_site, mock_run):
        # Setup mocks
        ...
        with patch("sys.argv", ["strava-collections", "-i", "examples/taiwan.yml", "--serve", "--host"]):
            try:
                main()
            except SystemExit:
                pass
        ...
        self.assertTrue(found_dev_call, f"Expected dev call {expected_dev_call} not found in {npm_calls}")
